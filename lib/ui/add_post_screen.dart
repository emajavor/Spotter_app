...
////////////////////////////////////////////
  ...
  Widget build(BuildContext context) {
                    ...
                    builder: (context, state) {
                      ...
                      if (state is AddedExercises) {
                        ...
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children:
                                state.addedExercises.map((exercise) => Padding(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          if (exerciseController.text.isNotEmpty) {
                            context.read<PostBloc>().add(AddExercises(addedExercises: exerciseController.text));
                  ...
                  BlocBuilder<PostBloc, PostState>(
                    ...
                    builder: (context, state) {
                      ...
                      if (state is AddedWorkoutType) {
                        workoutType = state.addedWorkoutType;} // Spremi vrijednost iz Bloca
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                              if (workoutType != null)
                            ...
                            Padding(
                              ...
                              child: TextField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: Icon(Icons.fitness_center, color: Theme.of(context).colorScheme.primary),
                                ),
                                ...
                                child: ElevatedButton(
                                  onPressed: () {
                                    if (workoutTypeController.text.isNotEmpty) {
                                      context
                                          .read<PostBloc>()
                                          .add(AddWorkoutType(addedWorkoutType: workoutTypeController.text));
                ...
                children: [
                  ...
                  BlocBuilder<PostBloc, PostState>(
                    ...
                    builder: (context, state) {
                      ...
                      location = state.addedLocation; // Spremi vrijednost iz Bloca
                      }
                        return Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            ...
                            Center(
                              child: Padding(
                                ...
                                context
                                    .read<PostBloc>()
                                    .add(AddLocation(addedLocation: locationController.text));
    ...
    prefixIcon: Icon(Icons.music_note, color: Theme.of(context).colorScheme.primary),
    ),
    style: GoogleFonts.poppins(color: Theme.of(context).colorScheme.onSurface),
    ),
    ),
    ...
    context
        .read<PostBloc>()
        .add(AddPlaylist(addedPlaylist: playlistController.text));
                ...
                child: ElevatedButton(
                  onPressed: () {
                    if (workoutTypeController.text.isEmpty &&
                        context.read<PostBloc>().state is! AddedWorkoutType) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Add workout type!',
                    ...
                    if (locationController.text.isEmpty && context.read<PostBloc>().state is! AddedLocation) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Add your location!',
                    ...
                    if (context.read<PostBloc>().state is! AddedExercises) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Add atleast one exercise!',
                            style: GoogleFonts.poppins(),
                          ),
                          backgroundColor: Theme.of(context).colorScheme.error,
                        ),
                    ...
                    final post = Post(
                      ...
                      intensity: selectedIntensity ?? Intensity.Easy,
                      exercises: (context.read<PostBloc>().state as AddedExercises?)?.addedExercises ?? [],
